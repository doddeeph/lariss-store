package id.lariss.store.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, id.lariss.store.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, id.lariss.store.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
