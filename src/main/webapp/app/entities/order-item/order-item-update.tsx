  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="larissStoreApp.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="larissStoreApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('larissStoreApp.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('larissStoreApp.orderItem.price')}
                id="order-item-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('larissStoreApp.orderItem.order')}
                type="select"
              >
                <option value="" key="0" />
                {orders
