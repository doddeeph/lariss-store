  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="larissStoreApp.cartItem.home.createOrEditLabel" data-cy="CartItemCreateUpdateHeading">
            <Translate contentKey="larissStoreApp.cartItem.home.createOrEditLabel">Create or edit a CartItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('larissStoreApp.cartItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('larissStoreApp.cartItem.price')}
                id="cart-item-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              <ValidatedField
                ...
                label={translate('larissStoreApp.cartItem.productVariant')}
                type="select"
              >
                <option value="" key="0" />
                {productVariants
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('larissStoreApp.cartItem.cart')}
                type="select"
              >
                <option value="" key="0" />
                {carts
